...
TICKERS = {
    ...
    'VAS.AX': {'name': 'Vanguard Australian Shares Index ETF', 'type': 'stock'},
    'VEU.AX': {'name': 'Vanguard FTSE All-world ex-US ETF', 'type': 'stock'},
    'IVV.AX': {'name': 'iShares S&P 500 ETF', 'type': 'stock'},
    'NDQ.AX': {'name': 'BetaShares NASDAQ 100 ETF', 'type': 'stock'},
