...
assert.equal(dashboardNetWorthExPpor([{month:'January',year:2026,netExPpor:1200000},{month:'July',year:2026,netExPpor:2300000}], 999), 2300000);
assert.equal(dashboardNetWorthExPpor([{month:'July',year:2026,net:2300000}], 999), 999);
