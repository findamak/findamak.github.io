...
const monthOnMonth = dashboardMonthOnMonthMetrics([
  {month:'June',year:2026,label:'June 2026',assets:[{id:'ppor',type:'primary_residence',balance:1000,fi:false},{id:'etf',type:'investment',balance:500,fi:true,accessible:true}],debts:[],income:{},expenses:{}},
  {month:'July',year:2026,label:'July 2026',assets:[{id:'ppor',type:'primary_residence',balance:1000,fi:false},{id:'etf',type:'investment',balance:400,fi:true,accessible:true}],debts:[],income:{},expenses:{}},
]);
assert.deepEqual(JSON.parse(JSON.stringify(monthOnMonth)), {netExPpor:-100,fi:-100,previousLabel:'June 2026',hasComparison:true});
